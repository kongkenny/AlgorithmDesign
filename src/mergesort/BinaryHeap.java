...
public class BinaryHeap
{
	...
	/*
	 * the heap is organized using the implicit array implementation. Array
	 * index 0 is not used
	 */
	 ...
	 * 
	 * @param capacity
	 *            number of active elements the heap can contain
	 */
	 ...
	 * 
	 * @param data
	 *            an array of data (no particular order)
